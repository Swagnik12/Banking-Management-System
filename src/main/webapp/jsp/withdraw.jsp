...
<head>
    ...
    <title>Withdraw Funds - FinTrust Global</title>
        ...
        <div class="dashboard-content">
            <div class="content-header">
                <div>
                    ...
                    <p class="page-subtitle">Cash out from your active accounts securely</p>
                </div>
            </div>
            ...
            <div class="main-grid">
                <!-- Withdraw Form -->
                <div class="card">
                    <h3 class="mb-4">Secure Withdrawal</h3>
                    ...
                    <form action="${pageContext.request.contextPath}/withdraw" method="post">
                        <div class="form-group">
                            <label for="accountNumber">Source Account</label>
                            <div class="input-wrapper">
                                <select id="accountNumber" name="accountNumber" required class="input-field">
                        ...
                        <button type="submit" class="btn btn-primary mt-2">
                            <svg fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" style="width:18px;height:18px;"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                ...
                <div class="column-side">
                    <div class="card limit-card">
                        ...
                        <div class="limit-info d-flex justify-between align-center mt-2">
                            ...
                            <span style="font-size:0.8rem; font-weight:700;">25%</span>
                        </div>
                    ...
                    <div class="card d-flex align-center" style="gap:1rem; flex-direction:row; padding:1.25rem;">
                        ...
                        <div>
                            <div style="font-weight:700; font-size:0.85rem; color:var(--text-primary);">Secure Withdrawal</div>
                            <div style="font-size:0.72rem; color:var(--text-secondary); line-height:1.35; margin-top:0.15rem;">All withdrawals are verified and encrypted. Funds available instantly.</div>
                        </div>
                    </div>
                </div>
            </div>
