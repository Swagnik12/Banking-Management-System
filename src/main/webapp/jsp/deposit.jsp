...
<head>
    ...
    <title>Deposit Funds - FinTrust Global</title>
            ...
            <div class="dashboard-content">
                <div class="content-header">
                    <div>
                        ...
                        <p class="page-subtitle">Add money into your checking or savings accounts securely</p>
                    </div>
                </div>

                <div class="main-grid">
                    <!-- Central Deposit Form Panel -->
                    <div class="card">
                        <h3 class="mb-4">Secure Deposit</h3>
                        ...
                        <form action="${pageContext.request.contextPath}/deposit" method="post">
                            <div class="form-group">
                                <label for="accountNumber">Target Account</label>
                    ...
                    <div class="column-side">
                        ...
                        <div class="card d-flex align-center" style="gap: 1rem; flex-direction: row; padding: 1.25rem;">
                            ...
                            <div>
                                ...
                                <div style="font-size: 0.72rem; color: var(--text-secondary); line-height: 1.35; margin-top: 0.15rem;">Deposits are protected by 256-bit encryption. Approved instantly.</div>
                            </div>
                        </div>
                    </div>
                </div>
