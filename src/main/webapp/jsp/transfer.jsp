...
<head>
    ...
    <style>
        ...
        select, input[type="text"], input[type="number"] { width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; box-sizing: border-box; font-size: 1rem; }
        select:focus, input[type="text"]:focus, input[type="number"]:focus { outline: none; border-color: #3b82f6; }
        .btn { background-color: #10b981; color: white; padding: 0.75rem 1.5rem; border: none; border-radius: 6px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: background-color 0.2s; width: 100%; }
...
<body>
    ...
    <div class="container">
        <div class="card">
            <h3>Send Money / Fund Transfer</h3>
            ...
            <form action="${pageContext.request.contextPath}/transfer" method="post">
                <div class="form-group">
                    <label for="fromAccountNumber">Debit From</label>
                    <select id="fromAccountNumber" name="fromAccountNumber" required>
                ...
                <div class="form-group">
                    <label for="toAccountNumber">Recipient Account Number (10 digits)</label>
                    <input type="text" id="toAccountNumber" name="toAccountNumber" required placeholder="0123456789">
                </div>
